...
class DeveloperPreview {
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.5Bn",percentage: 25.32)
    let state2 = StatisticModel(title: "Total Volume", value: "$41.22Bn")
    let state3 = StatisticModel(title: "Portfolio Volune", value: "$50.24k",percentage: -2.3)
    let coin = CoinModel(
       id: "bitcoin",
       symbol: "btc",
       name: "Bitcoin",
